...
### write out clean species group sheets.  NOTE: THIS IS SET TO eval = FALSE TO AVOID OVERWRITING SHEETS ACCIDENTALLY!
...
spp_data_out <- spp_data_clean %>%
  ...
  ungroup() %>%
  filter(sheet != 'fish_Beth') ### these were added to reef_fish
