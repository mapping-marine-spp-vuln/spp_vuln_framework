...
traits_all_gf <- bind_rows(gf_list) %>%
  ...
  filter(as.integer(gapfill) == min(as.integer(gapfill))) %>%
...
# traits_taxa_levels_key <- fread(here_anx('2_gapfill_traits/spp_up_down_gapfill_spp_traits.csv'))
# gapfill_lvls <- fread(here_anx('2_gapfill_traits/spp_up_down_gapfill_levels.csv'))
# traits <- fread(here_anx('2_gapfill_traits/spp_up_down_gapfill_traits.csv'))
# taxa <- fread(here_anx('2_gapfill_traits/spp_up_down_gapfill_taxa.csv'))
