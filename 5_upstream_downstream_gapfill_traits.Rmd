...
These have already been scrubbed of confounding symbols and parenthetical genera... 

```{r load expanded vuln scores from script 4}
match_df <- data.table::fread(here_anx('1_downfill_traits/spp_match_downfill_spp_traits.csv')) %>%
  full_join(data.table::fread(here_anx('1_downfill_traits/spp_match_downfill_levels.csv'))) %>%
  full_join(data.table::fread(here_anx('1_downfill_traits/spp_match_downfill_traits.csv'))) %>%
  full_join(data.table::fread(here_anx('1_downfill_traits/spp_match_downfill_taxa.csv'))) %>%
...
write_csv(gf_taxa,       here_anx('2_gapfill_traits/spp_up_down_gapfill_taxa.csv'))
write_csv(gf_traits,     here_anx('2_gapfill_traits/spp_up_down_gapfill_traits.csv'))
write_csv(gf_levels,     here_anx('2_gapfill_traits/spp_up_down_gapfill_levels.csv'))
write_csv(gf_spp_traits, here_anx('2_gapfill_traits/spp_up_down_gapfill_spp_traits.csv'))

### to reassemble:
# traits_gf_df <- data.table::fread(here_anx('2_gapfill_traits/spp_match_downfill_spp_traits.csv')) %>%
#   full_join(data.table::fread(here_anx('2_gapfill_traits/spp_match_downfill_levels.csv'))) %>%
#   full_join(data.table::fread(here_anx('2_gapfill_traits/spp_match_downfill_traits.csv'))) %>%
#   full_join(data.table::fread(here_anx('2_gapfill_traits/spp_match_downfill_taxa.csv'))) %>%
#   select(-starts_with('gf_match'))
